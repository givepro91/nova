...
6. **No company-internal dependencies** — never depend on 사내 전용 도구(내부 위키·문서 배포기·시크릿 매니저 등). Nova is a public, portable artifact; plugin users don't have those. All output self-contained.
